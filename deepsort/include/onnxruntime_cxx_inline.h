...
inline MemoryAllocation::MemoryAllocation(OrtAllocator* allocator, void* p,
                                          size_t size)
...
inline MemoryAllocation Ort::AllocatorWithDefaultOptions::GetAllocation(
    size_t size) {
  void* out;
  ThrowOnError(GetApi().AllocatorAlloc(p_, size, &out));
...
inline MemoryInfo MemoryInfo::CreateCpu(OrtAllocatorType type,
                                        OrtMemType mem_type) {
  OrtMemoryInfo* p;
...
inline void IoBinding::BindOutput(const char* name,
                                  const MemoryInfo& mem_info) {
  ThrowOnError(GetApi().BindOutputToDevice(p_, name, mem_info));
}

inline std::vector<std::string> IoBinding::GetOutputNamesHelper(
  ...
  size_t count = 0;
  ThrowOnError(
      GetApi().GetBoundOutputNames(p_, allocator, &buffer, &lengths, &count));
...
inline std::vector<std::string> IoBinding::GetOutputNames(
    Allocator& allocator) const {
  return GetOutputNamesHelper(allocator);
}

inline std::vector<Value> Ort::IoBinding::GetOutputValuesHelper(
    OrtAllocator* allocator) const {
  ...
  ThrowOnError(GetApi().GetBoundOutputValues(p_, allocator, &output_buffer,
                                             &output_count));
  if (output_count == 0) {
    return result;
  }
...
inline std::vector<Value> Ort::IoBinding::GetOutputValues(
    Allocator& allocator) const {
...
inline ArenaCfg::ArenaCfg(size_t max_mem, int arena_extend_strategy,
...
inline Env::Env(OrtLoggingLevel logging_level, _In_ const char* logid) {
  ...
  if (strcmp(logid, "onnxruntime-node") == 0) {
    ThrowOnError(GetApi().SetLanguageProjection(
...
inline Env::Env(OrtLoggingLevel logging_level, const char* logid,
  ...
  ThrowOnError(GetApi().CreateEnvWithCustomLogger(
...
inline Env::Env(const OrtThreadingOptions* tp_options,
                OrtLoggingLevel logging_level, _In_ const char* logid) {
  ThrowOnError(GetApi().CreateEnvWithGlobalThreadPools(logging_level, logid,
                                                       tp_options, &p_));
  if (strcmp(logid, "onnxruntime-node") == 0) {
    ThrowOnError(GetApi().SetLanguageProjection(
        p_, OrtLanguageProjection::ORT_PROJECTION_NODEJS));
...
inline RunOptions& RunOptions::AddConfigEntry(const char* config_key,
...
inline SessionOptions& SessionOptions::SetIntraOpNumThreads(
    int intra_op_num_threads) {
  ThrowOnError(GetApi().SetIntraOpNumThreads(p_, intra_op_num_threads));
  return *this;
}

inline SessionOptions& SessionOptions::SetInterOpNumThreads(
...
inline SessionOptions& SessionOptions::SetGraphOptimizationLevel(
  ...
  ThrowOnError(
      GetApi().SetSessionGraphOptimizationLevel(p_, graph_optimization_level));
  return *this;
}
...
inline SessionOptions& SessionOptions::SetOptimizedModelFilePath(
  ...
  ThrowOnError(
      GetApi().SetOptimizedModelFilePath(p_, optimized_model_filepath));
  return *this;
}

inline SessionOptions& SessionOptions::EnableProfiling(
...
inline SessionOptions& SessionOptions::SetExecutionMode(
...
inline SessionOptions& SessionOptions::AddExternalInitializers(
  ...
  ThrowOnError(GetApi().AddExternalInitializers(
      p_, names_ptr.data(), ort_values_ptrs.data(), inputs_num));
  return *this;
}

inline SessionOptions& SessionOptions::AppendExecutionProvider_CUDA(
    const OrtCUDAProviderOptions& provider_options) {
  ThrowOnError(GetApi().SessionOptionsAppendExecutionProvider_CUDA(
      p_, &provider_options));
  return *this;
}
...
inline SessionOptions& SessionOptions::AppendExecutionProvider_CUDA_V2(
  ...
  ThrowOnError(GetApi().SessionOptionsAppendExecutionProvider_CUDA_V2(
      p_, &provider_options));
  return *this;
}
...
inline SessionOptions& SessionOptions::AppendExecutionProvider_ROCM(
  ...
  ThrowOnError(GetApi().SessionOptionsAppendExecutionProvider_ROCM(
      p_, &provider_options));
  return *this;
}
...
inline SessionOptions& SessionOptions::AppendExecutionProvider_TensorRT_V2(
  ...
  ThrowOnError(GetApi().SessionOptionsAppendExecutionProvider_TensorRT_V2(
      p_, &provider_options));
  return *this;
}
...
inline SessionOptions& SessionOptions::AppendExecutionProvider_MIGraphX(
  ...
  ThrowOnError(GetApi().SessionOptionsAppendExecutionProvider_MIGraphX(
      p_, &provider_options));
  return *this;
}
...
inline SessionOptions& SessionOptions::SetCustomCreateThreadFn(
  ...
  ThrowOnError(GetApi().SessionOptionsSetCustomCreateThreadFn(
      p_, ort_custom_create_thread_fn));
  return *this;
}
...
inline SessionOptions& SessionOptions::SetCustomJoinThreadFn(
  ...
  ThrowOnError(GetApi().SessionOptionsSetCustomJoinThreadFn(
      p_, ort_custom_join_thread_fn));
  return *this;
}

inline SessionOptions& SessionOptions::AppendExecutionProvider_OpenVINO(
    const OrtOpenVINOProviderOptions& provider_options) {
  ThrowOnError(GetApi().SessionOptionsAppendExecutionProvider_OpenVINO(
      p_, &provider_options));
  return *this;
}

inline Session::Session(Env& env, const ORTCHAR_T* model_path,
...
inline Session::Session(Env& env, const void* model_data,
                        size_t model_data_length,
                        const SessionOptions& options) {
  ThrowOnError(GetApi().CreateSessionFromArray(
      env, model_data, model_data_length, options, &p_));
}
...
inline std::vector<Value> Session::Run(const RunOptions& run_options,
  ...
  Run(run_options, input_names, input_values, input_count, output_names,
      output_values.data(), output_names_count);
  return output_values;
}

inline void Session::Run(const RunOptions& run_options,
                         const char* const* input_names,
  ...
  static_assert(sizeof(Value) == sizeof(OrtValue*),
                "Value is really just an array of OrtValue* in memory, so we "
                "can reinterpret_cast safely");
  auto ort_input_values =
      reinterpret_cast<const OrtValue**>(const_cast<Value*>(input_values));
  auto ort_output_values = reinterpret_cast<OrtValue**>(output_values);
  ThrowOnError(GetApi().Run(p_, run_options, input_names, ort_input_values,
...
inline char* Session::GetInputName(size_t index,
                                   OrtAllocator* allocator) const {
  char* out;
...
inline char* Session::GetOutputName(size_t index,
                                    OrtAllocator* allocator) const {
  char* out;
...
inline AllocatedStringPtr Session::GetInputNameAllocated(
...
inline AllocatedStringPtr Session::GetOutputNameAllocated(
    size_t index, OrtAllocator* allocator) const {
  char* out;
  ThrowOnError(GetApi().SessionGetOutputName(p_, index, allocator, &out));
  return AllocatedStringPtr(out, detail::AllocatedFree(allocator));
...
inline char* Session::GetOverridableInitializerName(
    size_t index, OrtAllocator* allocator) const {
  char* out;
  ThrowOnError(GetApi().SessionGetOverridableInitializerName(p_, index,
                                                             allocator, &out));
  return out;
}
...
inline AllocatedStringPtr Session::EndProfilingAllocated(
    OrtAllocator* allocator) const {
  char* out;
  ThrowOnError(GetApi().SessionEndProfiling(p_, allocator, &out));
  return AllocatedStringPtr(out, detail::AllocatedFree(allocator));
...
inline char* ModelMetadata::LookupCustomMetadataMap(
...
inline char** ModelMetadata::GetCustomMetadataMapKeys(
    OrtAllocator* allocator, _Out_ int64_t& num_keys) const {
  char** out;
  ThrowOnError(GetApi().ModelMetadataGetCustomMetadataMapKeys(p_, allocator,
                                                              &out, &num_keys));
  return out;
}
...
inline TypeInfo Session::GetOverridableInitializerTypeInfo(size_t index) const {
  OrtTypeInfo* out;
  ThrowOnError(
      GetApi().SessionGetOverridableInitializerTypeInfo(p_, index, &out));
  return TypeInfo{out};
}

inline ONNXTensorElementDataType TensorTypeAndShapeInfo::GetElementType()
    const {
...
inline void TensorTypeAndShapeInfo::GetDimensions(int64_t* values,
                                                  size_t values_count) const {
  ThrowOnError(GetApi().GetDimensions(p_, values, values_count));
}

inline void TensorTypeAndShapeInfo::GetSymbolicDimensions(
    const char** values, size_t values_count) const {
...
inline Unowned<TensorTypeAndShapeInfo> TypeInfo::GetTensorTypeAndShapeInfo()
    const {
  const OrtTensorTypeAndShapeInfo* out;
  ThrowOnError(GetApi().CastTypeInfoToTensorInfo(p_, &out));
  return Unowned<TensorTypeAndShapeInfo>(
...
template <typename T>
inline Value Value::CreateTensor(const OrtMemoryInfo* info, T* p_data,
                                 size_t p_data_element_count,
                                 const int64_t* shape, size_t shape_len) {
  return CreateTensor(info, p_data, p_data_element_count * sizeof(T), shape,
                      shape_len, TypeToTensorType<T>::type);
}

inline Value Value::CreateTensor(const OrtMemoryInfo* info, void* p_data,
                                 size_t p_data_byte_count, const int64_t* shape,
                                 size_t shape_len,
                                 ONNXTensorElementDataType type) {
  OrtValue* out;
  ThrowOnError(GetApi().CreateTensorWithDataAsOrtValue(
...
inline Value Value::CreateSparseTensor(const OrtMemoryInfo* info, T* p_data,
  ...
  return CreateSparseTensor(info, p_data, dense_shape, values_shape,
...
inline void Value::FillSparseTensorCoo(const OrtMemoryInfo* mem_info,
                                       ...
                                       size_t indices_num) {
  ThrowOnError(GetApi().FillSparseTensorCoo(
      p_, mem_info, values_param.values_shape, values_param.values_shape_len,
...
inline void Value::FillSparseTensorCsr(const OrtMemoryInfo* data_mem_info,
  ...
  ThrowOnError(GetApi().FillSparseTensorCsr(
      p_, data_mem_info, values.values_shape, values.values_shape_len,
      values.data.p_data, inner_indices_data, inner_indices_num,
      outer_indices_data, outer_indices_num));
}

inline void Value::FillSparseTensorBlockSparse(
...
inline void Value::UseCsrIndices(int64_t* inner_data, size_t inner_num,
                                 int64_t* outer_data, size_t outer_num) {
  ThrowOnError(
      GetApi().UseCsrIndices(p_, inner_data, inner_num, outer_data, outer_num));
}

inline void Value::UseBlockSparseIndices(const Shape& indices_shape,
                                         int32_t* indices_data) {
  ThrowOnError(GetApi().UseBlockSparseIndices(
      p_, indices_shape.shape, indices_shape.shape_len, indices_data));
}
...
inline TensorTypeAndShapeInfo Value::GetSparseTensorValuesTypeAndShapeInfo()
    const {
...
inline TensorTypeAndShapeInfo Value::GetSparseTensorIndicesTypeShapeInfo(
  ...
  OrtTensorTypeAndShapeInfo* output;
  ThrowOnError(
      GetApi().GetSparseTensorIndicesTypeShape(p_, indices_format, &output));
  return TensorTypeAndShapeInfo{output};
}

template <typename T>
inline const T* Value::GetSparseTensorIndicesData(
    OrtSparseIndicesFormat indices_format, size_t& num_indices) const {
  const void* out;
  ThrowOnError(
      GetApi().GetSparseTensorIndices(p_, indices_format, &num_indices, &out));
  return reinterpret_cast<const T*>(out);
}
#endif  // !defined(DISABLE_SPARSE_TENSORS)

template <typename T>
inline Value Value::CreateTensor(OrtAllocator* allocator, const int64_t* shape,
                                 size_t shape_len) {
...
#if !defined(DISABLE_SPARSE_TENSORS)
template <typename T>
inline Value Value::CreateSparseTensor(OrtAllocator* allocator,
                                       const Shape& dense_shape) {
...
inline Value Value::CreateSparseTensor(OrtAllocator* allocator,
                                       ...
                                       ONNXTensorElementDataType type) {
  OrtValue* out;
  ThrowOnError(GetApi().CreateSparseTensorAsOrtValue(
...
inline Value Value::CreateSequence(std::vector<Value>& values) {
  OrtValue* out;
  std::vector<OrtValue*> values_ort{values.data(),
                                    values.data() + values.size()};
  ThrowOnError(GetApi().CreateValue(values_ort.data(), values_ort.size(),
                                    ONNX_TYPE_SEQUENCE, &out));
  return Value{out};
}
...
inline Value Value::CreateOpaque(const char* domain, const char* type_name,
  ...
  OrtValue* out;
  ThrowOnError(GetApi().CreateOpaqueValue(domain, type_name, &data_container,
                                          sizeof(T), &out));
  return Value{out};
}

template <typename T>
inline void Value::GetOpaqueData(const char* domain, const char* type_name,
                                 T& out) const {
...
inline void Value::GetStringTensorContent(void* buffer, size_t buffer_length,
                                          size_t* offsets,
                                          size_t offsets_count) const {
  ThrowOnError(GetApi().GetStringTensorContent(p_, buffer, buffer_length,
                                               offsets, offsets_count));
}

inline void Value::GetStringTensorElement(size_t buffer_length,
                                          size_t element_index,
                                          void* buffer) const {
  ThrowOnError(GetApi().GetStringTensorElement(p_, buffer_length, element_index,
                                               buffer));
}
...
inline T& Value::At(const std::vector<int64_t>& location) {
  ...
  T* out;
  ThrowOnError(
      GetApi().TensorAt(p_, location.data(), location.size(), (void**)&out));
  return *out;
}
...
inline std::string CustomOpApi::KernelInfoGetAttribute<std::string>(
  ...
  // attribute
  OrtStatus* status =
      api_.KernelInfoGetAttribute_string(info, name, nullptr, &size);

  if (status == nullptr) {
    out.resize(size);
    ThrowOnError(
        api_.KernelInfoGetAttribute_string(info, name, &out[0], &size));
...
template <>
inline std::vector<float> CustomOpApi::KernelInfoGetAttribute(
    _In_ const OrtKernelInfo* info, _In_ const char* name) {
  size_t size = 0;
  ...
  OrtStatus* status =
      api_.KernelInfoGetAttributeArray_float(info, name, nullptr, &size);

  if (status == nullptr) {
    out.resize(size);
    ThrowOnError(
        api_.KernelInfoGetAttributeArray_float(info, name, out.data(), &size));
  } else {
    ThrowOnError(status);
  }
  return out;
...
template <>
inline std::vector<int64_t> CustomOpApi::KernelInfoGetAttribute(
    _In_ const OrtKernelInfo* info, _In_ const char* name) {
  size_t size = 0;
  ...
  // Feed nullptr for the data buffer to query the true size of the attribute
  OrtStatus* status =
      api_.KernelInfoGetAttributeArray_int64(info, name, nullptr, &size);

  if (status == nullptr) {
    out.resize(size);
    ThrowOnError(
        api_.KernelInfoGetAttributeArray_int64(info, name, out.data(), &size));
  } else {
    ThrowOnError(status);
  }
  return out;
}
inline OrtTensorTypeAndShapeInfo* CustomOpApi::GetTensorTypeAndShape(
...
inline size_t CustomOpApi::GetTensorShapeElementCount(
...
inline size_t CustomOpApi::GetDimensionsCount(
    _In_ const OrtTensorTypeAndShapeInfo* info) {
  size_t out;
...
inline void CustomOpApi::GetDimensions(
    _In_ const OrtTensorTypeAndShapeInfo* info, _Out_ int64_t* dim_values,
...
inline T* CustomOpApi::GetTensorMutableData(_Inout_ OrtValue* value) {
  T* data;
  ThrowOnError(
      api_.GetTensorMutableData(value, reinterpret_cast<void**>(&data)));
  return data;
}

inline const OrtMemoryInfo* CustomOpApi::GetTensorMemoryInfo(
    _In_ const OrtValue* value) {
...
inline std::vector<int64_t> CustomOpApi::GetTensorShape(
    const OrtTensorTypeAndShapeInfo* info) {
...
inline void CustomOpApi::ReleaseTensorTypeAndShapeInfo(
    OrtTensorTypeAndShapeInfo* input) {
  api_.ReleaseTensorTypeAndShapeInfo(input);
}

inline size_t CustomOpApi::KernelContext_GetInputCount(
...
inline const OrtValue* CustomOpApi::KernelContext_GetInput(
    const OrtKernelContext* context, _In_ size_t index) {
  const OrtValue* out;
  ThrowOnError(api_.KernelContext_GetInput(context, index, &out));
  return out;
}

inline size_t CustomOpApi::KernelContext_GetOutputCount(
    const OrtKernelContext* context) {
  size_t out;
...
inline OrtValue* CustomOpApi::KernelContext_GetOutput(
    OrtKernelContext* context, _In_ size_t index,
    _In_ const int64_t* dim_values, size_t dim_count) {
  OrtValue* out;
  ThrowOnError(api_.KernelContext_GetOutput(context, index, dim_values,
                                            dim_count, &out));
  return out;
}

inline void* CustomOpApi::KernelContext_GetGPUComputeStream(
    const OrtKernelContext* context) {
  void* out;
...
inline OrtOp* CustomOpApi::CreateOp(
    _In_ const OrtKernelInfo* info, _In_ const char* op_name,
  ...
  OrtOp* ort_op{};
  ThrowOnError(api_.CreateOp(info, op_name, domain, version,
                             type_constraint_names, type_constraint_values,
                             type_constraint_count, attr_values, attr_count,
                             input_count, output_count, &ort_op));
  return ort_op;
}
...
inline void CustomOpApi::InvokeOp(_In_ const OrtKernelContext* context,
  ...
  ThrowOnError(api_.InvokeOp(context, ort_op, input_values, input_count,
...
inline OrtKernelInfo* CustomOpApi::CopyKernelInfo(
...
inline void CustomOpApi::ReleaseKernelInfo(
    _Frees_ptr_opt_ OrtKernelInfo* info_copy) {
